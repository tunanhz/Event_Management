...
/* SVG icons for each category - professional, consistent line icons */
  ...
  return (
    <section className={styles.section}>
      <div className={styles.container}>
        <nav className={styles.list} aria-label="Danh mục sự kiện">
          {categories.map((cat) => (
            <a key={cat.id} href={`/danh-muc/${cat.slug}`} className={styles.item}>
